        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                if persistent.playthrough == 1:
                    ...
                    textbutton _("Play Alpha") action If(persistent.playername, true=Start(), false=Show(screen="name_input", message="Please enter your name", ok_action=Function(FinishEnterName)))
                    textbutton _("Changelog") action [ShowMenu("changelog"), SensitiveIf(renpy.get_screen("changelog") == None)]
            ...
            if renpy.variant("pc"):
                ...
                #Feedback Submission
                textbutton _("Send Feedback") action Help("feedback.html")
...
screen changelog():
    ...
    use game_menu(_("Changelog"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Version 0.1a: Initial Alpha Release")
            text _("Version 0.2a: Fixed Error While Running The Game")
