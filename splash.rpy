...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "My Story is a DDLC fan mod that is not affiliated with Team Salvato in any form."
        "It is recommended that you play through the original game, as this mod contains spoilers for the base game."
        "Game files for Doki Doki Literature Club are required to play this mod and can be downloaded for free at: http://ddlc.moe"
        menu:
            "By playing My Story you agree that you have completed Doki Doki Literature Club and accept any spoilers contained within."
            "I agree.":
                "This is a pre-release Alpha build of My Story."
                "Please be advised that this version may not represent the final product and the content from here on in is subject to change."
                "From all of us at Eclipse Studio, we hope you enjoy this mod!"
                "If you happen to run into a bug in this mod, please don't hesitate to contact us at eclipsestudiohq@gmail.com"
                pass
        scene tos2
        with Dissolve(1.5)
        pause 1.0
